        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">รายละเอียดข้อมูลโปรโมชั่น</h2>
            </div>
          </header>
                      ...
                      <?php
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                              ...
                              <input type="text" class="form-control" name="pro_name" value="<?php echo $row['pro_name'];?>" readonly>
                            </div>
                            <div class="form-group col-md-3">
                              <label for="inputState">วันที่เริ่มโปรโมชั่น<b style="color:red;font-size:15px;"></b></label>
                              <input type="text" class="form-control" name="pro_startdate" value="<?php echo DateThai($row['pro_startdate']);?>" readonly>
                            </div>
                            <div class="form-group col-md-3">
                              <label for="inputState">วันที่สิ้นสุดโปรโมชั่น <b style="color:red;font-size:15px;"></b></label>
                              <input type="text" class="form-control" name="pro_enddate" value="<?php echo DateThai($row['pro_enddate']);?>" readonly>
                            </div>
                        </div>
                        <div class="form-row">
                          <div class="form-group col-md-4">
                            <label for="inputCity">ราคาโปรโมชั่น <b style="color:red;font-size:15px;"></b></label>
                            <input type="text" class="form-control" name="pro_price" value="<?php echo $row['pro_price'];?>" readonly>
                          </div>
                       
                        <div class="form-group col-md-4">
                            <label for="Proviance">จำนวนของแถม / ชิ้น <b style="color:red;font-size:15px;"></b></label>
                            <input type="text" class="form-control" name="pro_freegift" value="<?php echo $row['pro_freegift'];?>" readonly>
                          </div>
                        </div>
                        <?php }}?>
                        <div class="form-row" style="margin-top: 25px;">
                          <div class="form-group col-md-12">
                            <center>
                              <a href="./promotion.php" class="adddata btn btn-info text-center">ย้อนกลับ</a>
                            </center>
                          </div>
                        </div>
                        </form>
