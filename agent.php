        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">จัดการข้อมูลตัวแทนจำหน่วย</h2>
            </div>
          </header>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                  <div class="line-chart-example card">
                    ...
                    <a href="./agent-add.php" class="adddata btn btn-success">เพิ่มข้อมูล</a>
                    </div>
                    <div class="card-body">
                    <table id="perfixTables" class="table table-striped table-bordered">
                          <thead>
                            <tr>
                              <th class="text-center" style='width:10%;'>รหัสตัวแทนจำหน่วย</th>
                              <th class="text-center">ชื่อร้าน</th>
                              <th class="text-center">ที่อยู่</th>
                              <th class="text-center">เบอร์โทรศัพท์</th>
                              <th class="text-center">ชื่อผู้ติดต่อ</th>
                              <th class="text-center">เบอร์โทรศัพท์ผู้ติดต่อ</th>
                          ...
                          <tbody>
                              ...
                              ?>
                                    ...
                                    <td class="text-center"><?php echo $row['agent_shopname']?></td>
                                    <td class="text-center ">
                                      <?php echo $row['agent_address']?>
                                      <?php
                                        $sqldistrict = "SELECT * FROM district where DISTRICT_ID='".$row['agent_tambon']."'";
                                        ...
                                        <?php }}?>
                                        <?php
                                        $sqlamphur = "SELECT * FROM amphur where AMPHUR_ID='".$row['agent_amphoe']."'";
                                        ...
                                        <?php }}?>
                                        <?php
                                        $sqlprovince = "SELECT * FROM province where PROVINCE_ID='".$row['agent_province']."'";
                                        ...
                                        <?php }}?>
                                        <?php echo $row['agent_postalcode']?>
                                      </td>
                                    <td class="text-right"><?php echo $row['agent_tel']?></td>
                                    <td class="text-center"><?php echo $row['agent_name']?></td>
                                    <td class="text-right"><?php echo $row['agent_telcontact']?></td>
                                    <td class="text-center">
                                        <a class="btn" href="./agent-view.php?id=<?php echo $row['agent_id']?>" ><i class='fa fa-eye' style='font-size:25px;color:blue'></i></a>
                                        <a class="btn" href="./agent-edit.php?id=<?php echo $row['agent_id']?>"> <i class='fa fa-edit' style='font-size:25px;color:orange'></i></a>
                                       <button id="deletedata" class="btn" value="<?php echo $row['agent_id']?>,<?php echo $row['agent_shopname']?>" ><i class='fa fa-trash-o' style='font-size:25px;color:red'></i></button>
                                    </td>
                                    </tr>
                                        <?php } }?>
                          </tbody>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <center>
                  <b><h4> คุณแน่ใจที่จะลบข้อมูลตัวแทนจำหน่วย  : <b id="checkdata"></b></h4></b>
                  </center>
                </div>
    ...
    <div class="modal fade" id="modaledit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <center>
                  <h4> คุณแน่ใจที่จะแก้ไขตัวแทนจำหน่วย  : <b id="checkedata"></b></h4>
                  </center>
                </div>
                <div class="modal-footer">
                  <button type="button" class="btn btn-secondary" data-dismiss="modal">ยกเลิก</button>
