                ...
                <div class="col-lg-12" >
                  <div class="line-chart-example card">
                    <div class="card-body">
                      ...
                      <b><h3 class="text-center">ข้อมูลการสั่งซื้อสินค้า</h3></b>
                      <div class="form-row">
                      ...
                      <?php
                                ...
                                if($result = mysqli_query($con, $sql)){
                                    while($row = mysqli_fetch_array($result)){
                                      $sqlagent = "SELECT * FROM agent where agent_id='".$row['agent_id']."' ";
                        ...
                        <div class="form-row border" style="padding-top: 10px;padding-left: 2%;border: 4px solid #000000!important;">
                            ...
                            <div class="form-group col-md-5" style="margin-top: -10px;">
                                  วันที่สั่งซื้อสินค้า : <?php echo DateThai($row['order_date']);?>
                            </div>
                            <div class="form-group col-md-7" style="margin-top: -10px;">
                              ...
                              ?>
                                <tr>
                                  ...
                                  <th>  <?php
                                      ...
                                      <?php }}?></th>
                                      <th  class="text-right"><?php echo number_format($rowpd['detail_amount']);?></th>
                                      <th> <?php
                                      $sqldtt = "SELECT * FROM units where unit_id ='".$unit."' ";
                                      if($resultdtt = mysqli_query($con, $sqldtt)){
                                          while($rowdtt = mysqli_fetch_array($resultdtt)){
                                          ?>
                                          <?php echo $rowdtt['unit_name'];?>
                                      <?php }}?></th>
                                      <th  class="text-right"><?php echo number_format($rowpd['detail_price'],2);?></th>
                                      <th  class="text-right"><?php $totalprice = $rowpd['detail_amount']*$rowpd['detail_price']; $totalprices+=$totalprice; echo number_format($totalprice,2);?></th>
                                </tr>
                              <? }}?>
                              <tr>
                                    <th colspan="6"><center>รวมเป็นเงินทั้งหมด &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <?php echo "( ".convert($totalprices)." )"?></center></th>
                       ...
                       <?php }}?>
                        ...
                        <div class="form-row" style="margin-top: 25px;">
                          <div class="form-group col-md-12">
                            <center>
                            <button id="cmd" class="btn btn-success"onclick="printDiv('printableArea')">ปริ้นใบเสร็จการสั่งซื้อสินค้า</button>
