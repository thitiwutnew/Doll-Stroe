...
<html>
  ...
  <body>
    <?php include('connect.php');
            $sqldataqurry = "SELECT * FROM prefix";
            if($resultdataqurry = mysqli_query($con, $sqldataqurry)){
                ...
                while($row = mysqli_fetch_array($resultdataqurry)){
                    if(substr($row['prefix_id'],2)==$count){
                      $count++;
                    }
                }
                if($count==0){$count++;}
              ...
              if(isset($_POST["add"])){
                ...
                if($_POST["prefix_name"]!=null){
                            $sqlposition = "SELECT * FROM prefix where prefix_name='".$_POST['prefix_name']."' ";
                            if($resultposition = mysqli_query($con, $sqlposition)){
                                ...
                                if($count>0){
                                  ...
                                  $(document).ready(function(){
                                    ...
                                    VALUES ('".$_POST["perfix_id"]."','".$_POST["prefix_name"]."')";

                                    if ($con->query($sql) === TRUE) {
                                      echo '<script>window.location.href="./perfix.php"</script>';
                                    } else {
                                      echo '<script>
                                      $(document).ready(function(){
        ...
        <div class="content-inner">
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">เพิ่มข้อมูลคำนำหน้าชื่อ</h2>
            </div>
          </header>
          <section class="dashboard-counts no-padding-bottom">
            <div class="container-fluid">
              <div class="row">
                  <div class="line-chart-example card" style="width: 100%;">
                    <div class="card-body">
                        ...
                        <hr>
                          <div class="form-row">
                              <div class="form-group col-md-12">
                                <label for="inputEmail4">รหัสคำนำหน้าชื่อ <b style="color:red;font-size:15px;">*</b></label>
                          ...
                          <div class="form-row">
                              <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" name="prefix_name" placeholder="กรอกข้อมูล" required>
                                <?php
                                  if($checkstatus==1){ ?>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <center>
                  <h4> เพิ่มข้อมูลคำนำหน้าชื่อ : <b><?php echo $_POST['prefix_name'];?></b> สำเร็จ</h4>
                  </center>
                </div>
      ...
      <div class="modal fade" id="modalerror" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <center>
                  <h4> เพิ่มข้อมูลคำนำหน้าชื่อ : <b><?php echo $_POST['prefix_name'];?></b> ไม่สำเร็จ</h4>
                  </center>
                </div>
                <div class="modal-footer">
