...
<html>
  ...
  <body onload="Add();">
    <?php
     include('connect.php');
     $sqldataqurry = "SELECT * FROM units";
     if($resultdataqurry = mysqli_query($con, $sqldataqurry)){
      ...
      if(isset($_POST["add"])){
        ...
        if($_POST["unit_name"]!=null){
                    ...
                    $sqlposition = "SELECT * FROM units where unit_name='".$_POST['unit_name']."'";
                    if($resultposition = mysqli_query($con, $sqlposition)){
                        ...
                        if($count>0){
                          ...
                          $(document).ready(function(){
                            ...
                            VALUES ('".$_POST["unit_id"]."','".$_POST["unit_name"]."')";

                            if ($con->query($sql) === TRUE) {
                              echo '<script>window.location.href="./measure.php"</script>';
                            } else {
                              echo '<script>
                              $(document).ready(function(){
        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">เพิ่มข้อมูลหน่วยนับ</h2>
            </div>
          </header>
                    ...
                    <div class="card-body">
                      ...
                      <hr>
                        <div class="form-row">
                            ...
                            <label for="inputEmail4">รหัสหน่วยนับ <b style="color:red;font-size:15px;">*</b></label>
                            <input type="text" class="form-control" name="unit_id" value="<?php echo $id;?>" readonly>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-12">
                              <label for="inputState">ชื่อหน่วยนับ <b style="color:red;font-size:15px;">*</b></label>
                              <input type="text" class="form-control" name="unit_name" placeholder="กรอกข้อมูล" required>
                              <?php
                                 if($checkstatus==1){ ?>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <center>
                  <h4> เพิ่มข้อมูลหน่วยวัด : <b><?php echo $_POST['unit_name'];?></b> สำเร็จ</h4>
                  </center>
                </div>
      ...
      <div class="modal fade" id="modalerror" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <center>
                  <h4> เพิ่มข้อมูลหน่วยวัด : <b><?php echo $_POST['unit_name'];?></b> ไม่สำเร็จ</h4>
                  </center>
                </div>
                <div class="modal-footer">
