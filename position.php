        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">จัดการข้อมูลตำแหน่ง</h2>
            </div>
          </header>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                  <div class="line-chart-example card">
                    ...
                    <button class="btn btn-success"><a href="./position-add.php" class="adddata">เพิ่มข้อมูล</a></button>
                    </div>
                    <div class="card-body">
                    <table id="perfixTables" class="table table-striped table-bordered">
                          <thead>
                            <tr>
                              <th class="text-center" style='width:10%;'>รหัสตำแหน่ง</th>
                          ...
                          <tbody>
                              ...
                              ?>
                                    ...
                                    <a  class="btn" href="./position-edit.php?id=<?php echo $row['position_id']?>"> <i class='fa fa-edit' style='font-size:25px;color:orange;margin-top:2px;'></i></a>
                                    <button id="deletedata" class="btn" value="<?php echo $row['position_id']?>,<?php echo $row['position_name']?>"> <i class='fa fa-trash-o' style='font-size:25px;color:red'></i></button>
                                    </td>
                                    </tr>
                                        <?php } }?>
                          </tbody>
