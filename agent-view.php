                    ...
                    <div class="card-body">
                      ...
                      <hr>
                        <div class="form-row">
                            ...
                            <label for="inputEmail4">รหัสตัวแทนจำหน่วย : <?php echo $row['agent_id'];?></label>
                            <hr>
                            </div>
                            <div class="form-group col-md-12">
                              <label for="inputState">ชื่อร้าน : <?php echo $row['agent_shopname'];?></label>
                              <hr>
                            </div>
                            <div class="form-group col-md-12 ">
                              <label for="inputCity">ที่อยู่ : <?php echo $row['agent_address'];?>
                              ตำบล    <?php
                              ...
                              จังหวัด        <?php
                                        ...
                                        <?php }}?> <?php echo $row['agent_postalcode'];?>
                              </label>
                              <hr>
                            </div>
                            <div class="form-group col-md-12">
                              <label for="inputState">ชื่อผู้ติดต่อ : <?php echo $row['agent_name'];?></label>
                              <hr>
                            </div>
                            <div class="form-group col-md-12">
                              <label for="inputState">เบอร์โทรศัพท์ :   <?php echo $row['agent_tel'];?></label>
                              <hr>
                            </div>
                        </div>
                        <div class="form-row">
                          <label for="inputEmail"><h3>ข้อมูลตัวแทนจำหน่วย</h3></label>
                          <div class="form-group col-md-12">
                          <hr>
                            <table class="table">
                              ...
                              $count=1;
                                include('connect.php');
                                $sqlpd = "SELECT * FROM agent_detail ad
                                join product pd on ad.product_id=pd.product_id where ad.agent_id='".$_GET['id']."'";
                                if($resultpd = mysqli_query($con, $sqlpd)){
                                    while($rowpd = mysqli_fetch_array($resultpd)){
                              ?>
                                  <tr>
                                      <th><?php echo  $count;  $count+=1;?></th>
                                      <th><?php echo $rowpd['product_name'];?></th>
                                      <th><?php echo number_format ($rowpd['product_wholesaleprice'],2);?></th>
                                  </tr>
                                <?php }}?>
                              </tbody>
                            </table>
                        ...
                        <div class="form-row" style="margin-top: 25px;">
                          <div class="form-group col-md-12">
                            <center>
                              ...
                              <a href="./agent.php" class="adddata btn btn-info text-center">กลับไปดูข้อมูลทั้งหมด</a>
                            </center>
                          </div>
                        </div>
                        <?php }}?>
