  ...
  <body onload="Add();">
    <?php 
     ...
     if($resultdataqurry = mysqli_query($con, $sqldataqurry)){
      ...
      if(isset($_POST["add"])){
        $checkstatus=0;
        if($_POST["seld_id"]!=null){
                        for($i=0;$i<count($_POST["seld_id"]);$i++)
                        {
                            $sqledit = "UPDATE selling_detail SET seld_amount='".$_POST["detail_amount"][$i]."'
                             WHERE seld_id='".$_POST['seld_id'][$i]."'"; 
                ...
                <?php
                  ...
                  <div class="line-chart-example card">
                    <div class="card-body">
                      ...
                      <?php 
                                include('connect.php');
                                $sql = "SELECT * FROM selling where sell_id='".$_GET['id']."' ";
                                if($result = mysqli_query($con, $sql)){
                                    while($row = mysqli_fetch_array($result)){
                              ?>
                        <div class="form-row">
                            <div class="form-group col-md-4">
                            <label for="inputEmail4">รหัสการขายสินค้า :</label>
                            <input type="text" class="form-control" name="order_id" value="<?php echo $row['sell_id'];?>" readonly>
                            </div>
                            <div class="form-group col-md-4">
                            <label for="inputEmail4">วันที่ขายสินค้า :</label>
                            <input type="text" class="form-control"  value="<?php echo DateThai($row['sell_date']);?>" readonly>
                            </div>
                            <div class="form-group col-md-4">
                        ...
                        <table class="table table-bordered">
                                ...
                                if($resultpd = mysqli_query($con, $sqlpd)){
                                    while($rowpd = mysqli_fetch_array($resultpd)){
                                        $countno +=1;
                                    ?>
                                    <input type="hidden" name="seld_id[]" value="<?php echo $rowpd['seld_id'];?>">
                                     <tr>
                                    ...
                                    <td>
                                    <input type="number" class="form-control" name="detail_amount[]" value="<?php echo $rowpd['seld_amount'];?>" >
                                    <input type="hidden" class="form-control" name="detail_amountold[]" value="<?php echo $rowpd['seld_amount'];?>" >
                                    </td>
                                    <td>
                                    <input type="number" class="form-control" name="detail_price[]" value="<?php echo $rowpd['seld_price'];?>" readonly>
                                    </td>
                                    <td>
                                    <p id="deletedata" class="imgAdd" value="<?php echo $rowpd['seld_id'];?>">ลบข้อมูล</p>
                                    </td>
                                    </tr>
                                    <?php }}?>
                                </tbody>
                        ...
                        <div class="form-row" style="margin-top: 25px;">
                          <div class="form-group col-md-12">
                            <center>
                              ...
                              <a id="editdata" class="btn btn-success text-center" value="<?php echo $row["sell_id"]?>">แก้ไขข้อมูล</a>
       ...
       <div class="modal fade" id="modalsuccess" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <center>
                  <h4> แก้ไขข้อมูลขายสินค้า : <b><?php echo $_POST['order_id'];?></b> สำเร็จ</h4>
                  </center>
                </div>
                <div class="modal-footer">
      ...
      <div class="modal fade" id="modalerror" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <center>
                  <h4> แก้ไขข้อมูลขายสินค้า : <b><?php echo $_POST['order_id'];?></b> ไม่สำเร็จ</h4>
                  </center>
                </div>
                <div class="modal-footer">
