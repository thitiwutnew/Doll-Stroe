...
<html>
  ...
  <body >
    <?php 
     include('connect.php');
     $sqldataqurry = "SELECT * FROM position where position_id='".$_GET['id']."'";
     if($resultdataqurry = mysqli_query($con, $sqldataqurry)){
      ...
      if(isset($_POST["add"])){
        ...
        if($_POST["position_name"]!=null){
            $sqlposition = "SELECT * FROM position where position_name='".$_POST['position_name']."' AND position_id!='".$_GET['id']."'";
            if($resultposition = mysqli_query($con, $sqlposition)){
                ...
                if($count>0){
                  ...
                  $(document).ready(function(){
                    ...
                    $sqledit = "UPDATE position SET position_name='".$_POST["position_name"]."' WHERE position_id='".$_GET['id']."'"; 
        ...
        <div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">แก้ไขข้อมูลตำแหน่ง</h2>
            </div>
          </header>
                      ...
                      <hr>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                              ...
                              <input type="text" class="form-control" name="position_name" value="<?php echo $name;?>">
                              <?php
                                 if($checkstatus==1){ ?>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <center>
                  <h4> แก้ไขข้อมูลตำแหน่ง : <b><?php echo $_POST['position_name'];?></b> สำเร็จ</h4>
                  </center>
                </div>
      ...
      <div class="modal fade" id="modalerror" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <center>
                  <h4> แก้ไขข้อมูลตำแหน่ง : <b><?php echo $_POST['position_name'];?></b> ไม่สำเร็จ</h4>
                  </center>
                </div>
                <div class="modal-footer">
